...
void Board::CheckGame()
{
  ...
  for (int i = 0; i <= 2; i++)
  {
    if (m_elements_array[i][0] == m_elements_array[i][1] &&
        m_elements_array[i][1] == m_elements_array[i][2] && m_elements_array[i][0] != -1)
    {
  ...
  for (int i = 0; i <= 2; i++)
  {
    if (m_elements_array[0][i] == m_elements_array[1][i] &&
        m_elements_array[1][i] == m_elements_array[2][i] && m_elements_array[0][i] != -1)
    {
  ...
  if (m_elements_array[0][0] == m_elements_array[1][1] &&
      m_elements_array[1][1] == m_elements_array[2][2] && m_elements_array[0][0] != -1)
  {
  ...
  if (m_elements_array[0][2] == m_elements_array[1][1] &&
      m_elements_array[1][1] == m_elements_array[2][0] && m_elements_array[0][2] != -1)
  {
